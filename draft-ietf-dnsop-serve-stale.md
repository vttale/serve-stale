...
that their servers are responding but not giving true authoritative
answers.
...
not handled that way because there is no effective way to tell the
...
caching.  Implementers may nonetheless wish to consider whether to
